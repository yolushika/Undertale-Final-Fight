...
| **JDK 21** | 运行环境 |
| **Maven 3.6+** | 构建工具 |
| **LWJGL 3.3.6** | 游戏引擎（OpenGL / GLFW / OpenAL） |
| **Gson 2.8.9** | JSON 配置解析 |
| **JUnit 5.9.3** | 单元测试 |
...
- **JDK 21** 或更高版本
- **Maven 3.6** 或更高版本
- Windows 操作系统（LWJGL natives 配置为 `natives-windows`）
...
- **项目链接**：[Undertale-Final-Fight](https://github.com/yolushika/Undertale-Final-Fight)
